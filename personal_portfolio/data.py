...
def get_achievements():
    ...
    return [
        ...
        {
            'title': 'Appreciation Award - Innovation Acquisition Summit-24 (Vikas-24)',
...
def get_certifications():
    ...
    return [
        ...
        },
        {
            ...
            'date': '2022',
            'image_url': 'https://cdn-icons-png.flaticon.com/512/6124/6124995.png',
            'credential_url': '#'
        },
        {
    ...
    return [
        {
            ...
            'description': 'Developed and maintained responsive web applications using HTML, CSS, JavaScript, and SQL while testing functionalities to ensure optimal performance and adherence to design specifications. Collaborated with software development teams to enhance user-focused solutions by contributing to debugging efforts and updating existing code libraries.',
            'type': 'Remote Work'
        },
        {
